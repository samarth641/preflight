...
import { recommendGPU } from "@/lib/api"
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2">
                {result.best_pick ? (
                  <BestPickCard candidate={result.best_pick} requiredVram={result.required_vram_gb} />
                ) : (
...
function BestPickCard({ candidate, requiredVram }: { candidate: GPUCandidate; requiredVram: number }) {
