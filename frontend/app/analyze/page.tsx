...
import { DollarSign, Clock, MemoryStick, AlertTriangle, Target, Cpu, Leaf, Zap, Lightbulb, CheckSquare, Download, FlaskConical } from "lucide-react"
        ...
        {!result && !loading && !error && (
          <Card>
            <EmptyState
              ...
              description="Configure your training parameters above and click Analyze to see predictions, recommendations, and AI explanations."
            />
          </Card>
        )}
      </div>
