        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card title="System Status">
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs text-[var(--text-secondary)]">ML Duration Predictor</span>
                <Badge variant="info">XGBoost v1</Badge>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-xs text-[var(--text-secondary)]">Benchmark Database</span>
                <span className="text-xs font-mono text-[var(--text)]">11 GPUs calibrated</span>
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-mono text-[var(--text-muted)]">0.2.0</span>
              </div>
            </div>
          </Card>
        </div>
